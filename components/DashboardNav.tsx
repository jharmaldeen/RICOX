...
const items = [
  ...
  { href: "/dashboard/verify-transaction", label: "Verify Transaction", icon: BadgeCheck },
];
...
export function DashboardNav({ open, onClose }: { open: boolean; onClose: () => void }) {
  ...
  return (
    <>
      ...
      >
        <Link href="/" className="mb-8 flex h-10 w-10 items-center justify-center" onClick={onClose}>
