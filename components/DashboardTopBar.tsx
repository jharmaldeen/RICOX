...
const titles: Record<string, string> = {
  ...
  "/dashboard/verify-transaction": "Verify Transaction",
  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between border-b border-line bg-navy/90 px-4 py-3 backdrop-blur-xl lg:px-6">
      <div className="flex items-center gap-3">
        ...
        <Link href="/dashboard" className="hidden rounded-lg p-2 text-muted hover:text-white sm:inline-flex">
      ...
      <div className="flex items-center gap-3">
        ...
        <Link href="/dashboard/portfolio" className="flex items-center gap-2 rounded-full py-1 pl-1 pr-2 hover:bg-surface-2">
